...
namespace ltm.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\H\Downloads\ltm2\ltm2\ltm\QLGH.mdf;Integrated Security=True";
        ...
        public static string GetPath3(string fname)
        {
